...
export default function AuthPage({ status, canResetPassword }: AuthPageProps) {
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="w-full lg:w-1/2 bg-gray-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-md">
                    {status && (
                        <div className="mb-4 p-3 rounded-lg bg-green-50 text-sm font-medium text-green-700">
                            {status}
                        </div>
                    )}
                                ...
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <Checkbox
                                        ...
                                        onChange={(e: React.FormEvent<HTMLButtonElement>) =>
                                            loginForm.setData('remember', (e.currentTarget as any).checked || false)
                                        }
                                    />
